  ...
  const sections = [
    {
      title: 'Movies',
      links: [
        { label: 'Latest News', href: '/category/movies' },
        { label: 'Reviews', href: '/category/movies' },
        { label: 'Trailers', href: '/category/movies' },
        { label: 'Box Office', href: '/category/movies' },
      ],
    },
    {
      title: 'Television',
      links: [
        { label: 'TV News', href: '/category/tv' },
        { label: 'Streaming', href: '/category/tv' },
        { label: 'Recaps', href: '/category/tv' },
        { label: 'Cancellations', href: '/category/tv' },
      ],
    },
    {
      title: 'Gaming',
      links: [
        { label: 'Game News', href: '/category/gaming' },
        { label: 'Reviews', href: '/category/gaming' },
        { label: 'Guides', href: '/category/gaming' },
        { label: 'Release Dates', href: '/category/gaming' },
      ],
    },
    {
      title: 'More',
      links: [
        { label: 'Comics', href: '/category/comics' },
        { label: 'Celebrity News', href: '/category/celebrity-news' },
        { label: 'Sports', href: '/category/sports' },
        { label: 'Tech & AI', href: '/category/ai' },
      ],
    },
    {
      title: 'Company',
    ...
    <footer className="bg-[#111] text-gray-400 border-t border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-gray-600">
          <p>&copy; {new Date().getFullYear()} CinemaRant. All rights reserved.</p>
          <div className="flex items-center gap-4">
